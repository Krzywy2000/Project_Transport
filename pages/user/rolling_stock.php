  ...
  <div class="container-fluid"><br /><br />
    ...
    <div id="result" class="result table-responsive">
      ...
      if ($_SESSION['access'] == 1) {
        ...
        $result_T = "SELECT * FROM `vehicles` where `typ_pojazdu`='trolejbus' ORDER BY `numer_tab`";
      } else {
          ...
          while ($row3 = $result3->fetch_array()) {
            echo "<tr style='border-bottom:1pt solid black'>
                                  <td>" . $row3['numer_tab'] . "</td>
								                  <td>" . $row3['typ_taboru'] . "</td>
                                  <td>" . $row3['marka'] . "</td>
                                  <td>" . $row3['model'] . "</td>
                                  <td>" . $row3['rocznik'] . "</td>
                                  <td>" . $row3['rok_wprowadzenia'] . "</td>
                                  ...
                                  <td>" . $row3['id_workshop'] . "</td>
                                      ...
                                      <button data-toggle='modal' data-target='#modal-szczegoly' data-idvehiclex='" . $row3['id'] . "'>szczegóły</button><br />
                                      <button data-toggle='modal' data-target='#modal-workshop' data-idmiasto='" . $row3['miasto'] . "' data-idvehicle='" . $row3['id'] . "'>Dodaj do warsztatu</button><br/>
                                      <button data-toggle='modal' data-target='#modal-delete-vehicles' data-delete-vehicle='" . $row3['id'] . "'>Usuń pojazd</button>
                                      </td>
            ...
            echo "<tr style='border-bottom:1pt solid black'>
                                  ...
                                  <td>" . $row2['uklad_drzwi'] . "</td>
                                    ...
                                    <td>" . $row2['id_workshop'] . "</td>
                                      ...
                                      <button data-toggle='modal' data-target='#modal-szczegoly' data-idvehiclex='" . $row2['id'] . "'>szczegóły</button><br />
                                     <button data-toggle='modal' data-target='#modal-workshop' data-idmiasto='" . $row2['miasto'] . "' data-idvehicle='" . $row2['id'] . "'>Dodaj do warsztatu</button><br/>
                                      <button data-toggle='modal' data-target='#modal-delete-vehicles' data-delete-vehicle='" . $row2['id'] . "'>Usuń pojazd</button>
                                      </td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="scripts/php/editor.php" method="POST" id="form-editor">
            ...
            Typ pojazdu :<select name="edycja_vehicle_type">
            ...
            Klimatyzacja :<select name="edycja_vehicle_klimatyzacja">
              <option value='TAK'>TAK</option>
              <option value='NIE'>NIE</option>
            </select><br /><br />
            Biletomat :<SELECT name="edycja_vehicle_biletomat">
              <option value='TAK'>TAK</option>
              <option value='NIE'>NIE</option>
            </select><br /><br />
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="scripts/php/add_to_stock.php" method="POST" id="form-add-to-stock">
            ...
            Klimatyzacja :<select name="add_vehicle_klimatyzacja">
              <option value='TAK'>TAK</option>
              <option value='NIE'>NIE</option>
            </select><br /><br />
            Biletomat :<SELECT name="add_vehicle_biletomat">
              <option value='TAK'>TAK</option>
              <option value='NIE'>NIE</option>
            </select><br /><br />
